...
#    noc_idx = get_noc(_noc, _foc, plot=False, fit_summary=True, ttest_cutoff=True, pvalue_cutoff=0.05, spread_asm=args.spread_asm, spread_foc=args.spread_foc)
#    est_ttest_5.append(_noc[noc_idx])
#
#    noc_idx = get_noc(_noc, _foc, plot=False, fit_summary=True, ttest_cutoff=True, pvalue_cutoff=0.01, spread_asm=args.spread_asm, spread_foc=args.spread_foc)
